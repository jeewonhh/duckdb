...
void LogicalMaterializedCTE::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(204, "must_execute", must_execute, false);
}
...
unique_ptr<LogicalOperator> LogicalMaterializedCTE::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithExplicitDefault<bool>(204, "must_execute", result->must_execute, false);
	return std::move(result);
}
